...
export const UNRIGGED_MODELS = {
  BLACK_GLASSES: { path: "kismet_glasses/scene.gltf", positionKeyPoint: ["left_eye", "right_eye"], offsets: { x: 0, y: 0 }, scale: { x: 7, y: 7, z: 5 }, desp: "Black Sunglasses" },
  EYES: { path: "eyes/scene.gltf", positionKeyPoint: ["left_eye", "right_eye"], offsets: { x: 0, y: 0 }, scale: { x: 0.5, y: 0.5, z: 1 }, desp: "Scary Eyes" },
  FUNK_TIARA: { path: "funk_glasses/scene.gltf", positionKeyPoint: ["left_eye", "right_eye"], offsets: { x: 0, y: 0 }, scale: { x: 0.35, y: 0.35, z: 0.1 }, desp: "Funky Female Sunglasses" },
  FMOUSE: { path: "fluffy_mustach/scene.gltf", positionKeyPoint: ["mouth_left", "mouth_right"], offsets: { x: 0, y: 0 }, scale: { x: 21.2, y: 21.2, z: 1 }, desp: "Dallas Mustache" },
  HEART_GLASSES: { path: "heart-shaped_glasses/scene.gltf", positionKeyPoint: ["left_eye", "right_eye"], offsets: { x: 0, y: 0 }, scale: { x: 0.5, y: 0.5, z: 0.7 }, desp: "Heart Shaped Sunglasses" },
  KMOUSE: { path: "kaiser_mustache/scene.gltf", positionKeyPoint: ["mouth_left", "mouth_right"], offsets: { x: 0, y: 0 }, scale: { x: 15, y: 15, z: 15 }, desp: "Royal Mustache" },
  LENS: { path: "Lens.gltf", positionKeyPoint: ["left_eye", "right_eye"], offsets: { x: 0, y: 0 }, scale: { x: 0.1, y: 0.1, z: 0.1 }, desp: "Red Eyelens" },
  MASK: { path: "Mask/mask.gltf", positionKeyPoint: ["left_eye", "right_eye"], offsets: { x: 0, y: 0 }, scale: { x: 2.5, y: 2.5, z: 2.5 }, desp: "Tribe Mask" },
  QUARTZ: { path: "Quartz_glasses/scene.gltf", positionKeyPoint: ["left_eye", "right_eye"], offsets: { x: 0, y: 0 }, scale: { x: 2, y: 2, z: 1 }, desp: "Circle Sunglasses" },
  SPECTACLES: { path: "glasses/scene.gltf", positionKeyPoint: ["left_eye", "right_eye"], offsets: { x: 0, y: 0 }, scale: { x: 1.5, y: 1.5, z: 1 }, desp: "Spectacles" },
};